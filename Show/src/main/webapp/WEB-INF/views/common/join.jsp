...
<script>
	$(document).ready(function(){
        ...
        if(chk) $(".check_text2 input").prop('checked', true);

        else  $(".check_text2 input").prop('checked', false);
		});
		//생년월일
	});
</script>
				...
				<div id="membership">
					...
					<div>
						...
						<div class="member_box">
							...
							<br />
							<input id="name_box"  class="size2" type="text" maxlength="30" placeholder="&nbsp;&nbsp;5글자 이하로 작성해주세요."/>
						</div>
						<div class="member_box">
							<label for="nickName_box" class="big_text">닉네임</label>
							<br />
							<input id="nickName_box"  class="size2" type="text" maxlength="30" placeholder="&nbsp;&nbsp;4글자 이하로 작성해주세요."/>
						</div>
						<div class="member_box">
						...
						<div class="sms_check">
							<div class="check2">
								<label for="all_search" class="check_text2">
								<input id="all_search" type="checkbox" />
								수신 전체 동의
								</label>
							</div>
							<div class="check2">
								<label for="sms_search" class="check_text2">
								<input id="sms_search" type="checkbox" />
								sms수신 동의(선택)
								</label>
							</div>
							<div class="check2">
								<label for="email_search" class="check_text2">
								<input id="email_search" type="checkbox" />
								e-mail수신 동의(선택)
								</label>
							</div>
						</div>
