...
<script type="text/javascript">
	...
	function leave_AX() {
		var a = confirm("회원탈퇴 신청을 하시면 30일 뒤에 정상적인 탈퇴가 가능합니다. 탈퇴신청을 하시겠습니까?");
		
		var email = '${email}';
		if(a){
		$.ajax({
			url : '/show/sign/leave_AX', //주소
			type : 'POST',
			data : {
				"member_email" : email
			},
		...
		<div class="join_bg">
			...
			<div id="membership_box">
				<div id="membership">
					<div>개인정보수정</div>
					<div align="right">
						<button class="leave" onclick="leave_AX()">회원탈퇴 신청</button>
					</div>
					<hr/>
					<br/>
					<div>
						<div class="member_box">
							<label for="id_box" class="big_text">이메일 주소</label> <br /> <input
								id="id_box_1" class="box_text" type="text" disabled="disabled"
								maxlength="30" placeholder="&nbsp;&nbsp;이메일 주소를 입력 하세요."
								value="${modi_email1}" /> @ <select id="id_box_2"
								disabled="disabled">
						...
						<div class="member_box">
							<label for="name_box" class="big_text">이름</label> <br /> <input
								...
								placeholder="&nbsp;&nbsp;5글자 이하로 작성해주세요." disabled="disabled"
								value="${modi_name}" />
						</div>
						<div class="member_box">
							<label for="nickName_box" class="big_text">닉네임</label> <br /> <input
								id="nickName_box" class="size2" type="text" maxlength="30"
								placeholder="&nbsp;&nbsp;4글자 이하로 작성해주세요." disabled="disabled"
								value="${modi_nickName}" />
						</div>
						<div class="member_box">
							<label for="pw_box1" class="big_text">새로운 비밀번호</label> <br /> <input
								id="pw_box1" class="size2" type="password" maxlength="30"
								placeholder="&nbsp;&nbsp;4~8자의 영문,숫자 조합으로 입력 하세요." />
						</div>
						<div class="member_box">
							<label for="pw_box2" class="big_text">새로운 비밀번호 확인</label> <br />
							<input id="pw_box2" class="size2" type="password" maxlength="30"
								onblur="pwd_check()" />
						</div>
						...
						<div class="member_box size_box">
							<label for="hp_box" class="big_text">휴대폰</label> <br /> <select
								...
								maxlength="4" / value="${modi_phone2}"> - <input
								id="hp_box_3" class="size5 box_text" type="text" maxlength="4"
								/ value="${modi_phone3}">
						...
						<div class="member_box">
							...
							<div class="size2">
								...
								</select> <select class="month" id="month" disabled="disabled">
								...
								</select> <select class="day" id="day" disabled="disabled">
